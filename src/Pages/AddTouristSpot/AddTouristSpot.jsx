            ...
            <div className="w-full bg-[#DCA06D] shadow-2xl my-5 rounded-xl">
                <form onSubmit={handleAddTouristSpot} className="card-body w-3/4 mx-auto">
                    <fieldset className="fieldset">
                        ...
                        <Slide direction='right' delay={200} duration={2800}>
                        ...
                        <Slide direction='left' delay={400} duration={2600}>
                        ...
                        <Slide direction='right' delay={600} duration={2400}>
                        ...
                        <Slide direction='left' delay={800} duration={2200}>
                        ...
                        <Slide direction='right' delay={1000} duration={2000}>
                        ...
                        <Slide direction='left' delay={1200} duration={1800}>
                            <button className="btn bg-[#5F99AE] mt-4 w-full">Add Tourist Spot</button>
                        </Slide>
                    </fieldset>
                </form>
            </div>
